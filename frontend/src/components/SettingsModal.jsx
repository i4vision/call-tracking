    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content" onClick={e => e.stopPropagation()}>
        ...
        <div className="modal-header">
          <h2><Key size={20} color="var(--accent-color)" style={{marginRight: 8}} /> API Configuration</h2>
          <p>Provide your secure API keys for AI models. Kept securely in Supabase.</p>
        </div>
